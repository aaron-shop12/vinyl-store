...
final class PW_Gift_Cards {
    ...
    function wp_enqueue_scripts() {
        ...
        wp_localize_script( 'pw-gift-cards', 'pwgc', array(
            ...
            'preview_padding'                   => apply_filters( 'pwgc_preview_padding', 32 ),
    ...
    // WPML (WooCommerce Multilingual plugin)
    function wcml_multi_currency_ajax_actions( $actions ) {
        if ( !in_array( 'pw-gift-cards-balance', $actions ) ) {
            $actions[] = 'pw-gift-cards-balance';
        }
    ...
    function output_gift_card() {
        ...
        if ( $gift_card_number != pwgc_get_example_gift_card_number() ) {
            ...
            if ( $gift_card->get_id() ) {
                $this->set_current_currency_to_default();
            } else {
