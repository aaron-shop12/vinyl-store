jQuery(function() {
    ...
    jQuery('#_pwgc_redemption_restrictions').on('change', function() {
        jQuery('#pwgc_redemption_restrictions_container').toggle(jQuery(this).is(':checked'));
    });

    jQuery('#woocommerce-product-data').on('woocommerce_variations_loaded', function() {
        var product_type = jQuery( 'select#product-type' ).val();
        jQuery('.variable_pwgc_redemption_restrictions').closest('.tips').toggle(product_type == pwgc.product_type_slug);

        jQuery('.variable_pwgc_redemption_restrictions').off('change.pwgc').on('change.pwgc', function() {
            jQuery(this).closest('.woocommerce_variation').find('.pwgc_variation_redemption_restrictions').toggle(jQuery(this).is(':checked'));
        });
    });
