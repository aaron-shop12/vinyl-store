...
<section class="banner">
    <span class="image">
        <?php $image = get_field('testimonials_banner_image','options'); ?>
        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
        <span class="overlay">
            <div class="container">
                <?php if(get_field('testimonials_banner_text','options')) { ?>
                    <span class="left"><h1><?php the_field('testimonials_banner_text','options'); ?></h1></span>
                <?php } ?>
            </div>    
        </span>
    </span>   
</section>
<section class="blog-listing-block testimonials">
    <div class="container">
