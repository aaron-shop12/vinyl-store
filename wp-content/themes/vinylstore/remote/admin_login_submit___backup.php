<?php
    ...
    if($user->roles[0]=='administrator' || $user->roles[0]=='editor'|| $user->roles[0]=='author'){
    ...
    if ($correct) {
       // echo "praksh"; exit;
        ...
        echo json_encode(array("result"=>"success", "message"=>"User and Password is Correct"));
    } else {
        echo json_encode(array("result"=>"error", "message"=>"User and Password is Incorrect"));
    }
